...
export async function GET(req: Request) {
  ...
  const reviews = await sql`SELECT id, name, role, dept, hire_date, last_review_date, review_history, next_review_override, review_status_override, review_cohort, review_6mo_date, review_6mo_status, review_1yr_date, review_1yr_status FROM employees ORDER BY name ASC`;
