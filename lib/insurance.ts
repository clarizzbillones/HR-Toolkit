...
// Best-effort next renewal date from the free-text "Renews" field (M/D/YYYY,
// M/D/YY, or M/D). Annual dates roll forward to the next occurrence. Returns
// null for "Active until cancelled" / "N/A" etc.
